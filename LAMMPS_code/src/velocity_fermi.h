...
CommandStyle(velocity_fermi,VelocityFermi)

#else

#ifndef LMP_VELOCITY_FERMI_H
#define LMP_VELOCITY_FERMI_H

#include "pointers.h"

namespace LAMMPS_NS {

class VelocityFermi : protected Pointers {
 public:
  VelocityFermi(class LAMMPS *);
