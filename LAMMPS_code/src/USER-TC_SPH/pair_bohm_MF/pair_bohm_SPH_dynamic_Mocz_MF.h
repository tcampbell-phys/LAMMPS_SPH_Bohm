...
PairStyle(bohm_SPH_dynamic_Mocz_MF,PairBohmSPHDynamicMoczMF)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_MF_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_MF_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczMF : public Pair {
 public:
  PairBohmSPHDynamicMoczMF(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczMF();
