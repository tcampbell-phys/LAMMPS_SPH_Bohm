...
PairStyle(coul/long/SPH_nopseudo_ph_sub_MF,PairCoulLongNopseudoSPHphsubMF)

#else

#ifndef LMP_PAIR_COUL_LONG_NOPSEUDO_SPH_PH_SUB_MF_H
#define LMP_PAIR_COUL_LONG_NOPSEUDO_SPH_PH_SUB_MF_H

#include "pair.h"

namespace LAMMPS_NS {

class PairCoulLongNopseudoSPHphsubMF : public Pair {
 public:
  PairCoulLongNopseudoSPHphsubMF(class LAMMPS *);
  ~PairCoulLongNopseudoSPHphsubMF();
