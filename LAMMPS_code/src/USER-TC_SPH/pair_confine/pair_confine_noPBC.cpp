...
PairConfineNoPBC::PairConfineNoPBC(LAMMPS *lmp) : Pair(lmp)
{
...
PairConfineNoPBC::~PairConfineNoPBC()
{
  if (allocated) {
...
void PairConfineNoPBC::compute(int eflag, int vflag)
{
  int i,ii,inum,itype;
...
void PairConfineNoPBC::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairConfineNoPBC::settings(int narg, char **arg)
{
...
void PairConfineNoPBC::coeff(int narg, char **arg)
{
...
void PairConfineNoPBC::init_style()
{
...
double PairConfineNoPBC::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairConfineNoPBC::write_restart(FILE *fp)
{
...
void PairConfineNoPBC::read_restart(FILE *fp)
{
...
void PairConfineNoPBC::write_restart_settings(FILE *fp)
{
...
void PairConfineNoPBC::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void *PairConfineNoPBC::extract(const char *str, int &dim)
{
