...
PairFilinovSinglet::PairFilinovSinglet(LAMMPS *lmp) : Pair(lmp)
{
...
PairFilinovSinglet::~PairFilinovSinglet()
{
  if (allocated) {
...
void PairFilinovSinglet::compute(int eflag, int vflag)
{
...
void PairFilinovSinglet::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairFilinovSinglet::settings(int narg, char **arg)
{
...
void PairFilinovSinglet::coeff(int narg, char **arg)
{
...
void PairFilinovSinglet::init_style()
{
...
double PairFilinovSinglet::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairFilinovSinglet::write_restart(FILE *fp)
{
...
void PairFilinovSinglet::read_restart(FILE *fp)
{
...
void PairFilinovSinglet::write_restart_settings(FILE *fp)
{
...
void PairFilinovSinglet::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
// double PairFilinovSinglet::single(int i, int j, int /*itype*/, int /*jtype*/,
//                             double rsq,
//                             double targ_temp)
// {
...
void *PairFilinovSinglet::extract(const char *str, int &dim)
{
