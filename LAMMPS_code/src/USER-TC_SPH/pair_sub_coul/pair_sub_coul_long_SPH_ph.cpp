...
#include "pair_sub_coul_long_SPH_ph.h"
#include "domain.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
...
PairSubCoulLongSPHph::PairSubCoulLongSPHph(LAMMPS *lmp) : Pair(lmp)
{
...
PairSubCoulLongSPHph::~PairSubCoulLongSPHph()
{
  if (copymode) return;
...
void PairSubCoulLongSPHph::compute(int eflag, int vflag)
{
...
void PairSubCoulLongSPHph::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairSubCoulLongSPHph::settings(int narg, char **arg)
{
...
void PairSubCoulLongSPHph::coeff(int narg, char **arg)
{
...
void PairSubCoulLongSPHph::init_style()
{
  if (!atom->q_flag)
...
double PairSubCoulLongSPHph::init_one(int i, int j)
{
  scale[j][i] = scale[i][j];
...
void PairSubCoulLongSPHph::write_restart(FILE *fp)
{
...
void PairSubCoulLongSPHph::read_restart(FILE *fp)
{
...
void PairSubCoulLongSPHph::write_restart_settings(FILE *fp)
{
...
void PairSubCoulLongSPHph::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
// double PairSubCoulLongSPHph::single(int i, int j, int /*itype*/, int /*jtype*/,
//                             double rsq,
...
void *PairSubCoulLongSPHph::extract(const char *str, int &dim)
{
...
int PairSubCoulLongSPHph::pack_forward_comm(int n, int *list, double *buf,
...
void PairSubCoulLongSPHph::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairSubCoulLongSPHph::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairSubCoulLongSPHph::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
