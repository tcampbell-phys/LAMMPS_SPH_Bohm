#ifdef FIX_CLASS
FixStyle(dynamic_widths_com_bp_mocz_rob_ftwo_diag,FixDynamicWidthsCoMBPMoczRobFtwoDiag)
#else
#ifndef LMP_FIX_DYNAMIC_WIDTHS_COM_BP_MOCZ_ROB_FTWO_DIAG_H
#define LMP_FIX_DYNAMIC_WIDTHS_COM_BP_MOCZ_ROB_FTWO_DIAG_H

#include "fix.h"

namespace LAMMPS_NS {
class FixDynamicWidthsCoMBPMoczRobFtwoDiag : public Fix {
 public:
  FixDynamicWidthsCoMBPMoczRobFtwoDiag(class LAMMPS *, int, char **);
  virtual ~FixDynamicWidthsCoMBPMoczRobFtwoDiag();
  int setmask();
  virtual void init();
