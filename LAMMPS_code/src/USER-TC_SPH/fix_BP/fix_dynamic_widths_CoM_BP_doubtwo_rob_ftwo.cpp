...
#include "fix_dynamic_widths_CoM_BP_doubtwo_rob_ftwo.h"
#include <cstring>
#include <mpi.h>
#include "group.h"
#include "modify.h"
...
FixDynamicWidthsCoMBPDoubtwoRobFtwo::FixDynamicWidthsCoMBPDoubtwoRobFtwo(LAMMPS *lmp, int narg, char **arg):
	Fix(lmp, narg, arg), mu(NULL), mu_all(NULL), tau(NULL), tau_all(NULL)
{
  ...
  // // fprintf(screen,"\nIn FixDynamicWidthsCoMBPDoubtwoRobFtwo with MPI_Allreduce and no commflag = 4 or 5");

  eflag = 0;
  eBohm = 0.0;
}

FixDynamicWidthsCoMBPDoubtwoRobFtwo::~FixDynamicWidthsCoMBPDoubtwoRobFtwo()
{
...
int FixDynamicWidthsCoMBPDoubtwoRobFtwo::setmask()
{
  int mask = 0;
...
void FixDynamicWidthsCoMBPDoubtwoRobFtwo::init()
{ 
...
void FixDynamicWidthsCoMBPDoubtwoRobFtwo::setup_pre_force(int)
{
  FixedPointIterator();
  CoM_Calculator();
}

void FixDynamicWidthsCoMBPDoubtwoRobFtwo::min_pre_force(int)
{
  FixedPointIterator();
  CoM_Calculator();
}
...
void FixDynamicWidthsCoMBPDoubtwoRobFtwo::setup_post_neighbor()
{
...
void FixDynamicWidthsCoMBPDoubtwoRobFtwo::post_neighbor()
{
  return;
}

void FixDynamicWidthsCoMBPDoubtwoRobFtwo::pre_force(int)
{
  FixedPointIterator();
  CoM_Calculator();
}

void FixDynamicWidthsCoMBPDoubtwoRobFtwo::end_of_step()
{
  // fprintf(screen,"\nFixDynamicWidthsCoMBPDoubtwoRobFtwo end_of_step");
  CalcBohmPot();
}

void FixDynamicWidthsCoMBPDoubtwoRobFtwo::FixedPointIterator()
{
...
double FixDynamicWidthsCoMBPDoubtwoRobFtwo::Gauss_Width_Deriv(double pre_fact, double wid, double sep_sq)
{
  return pre_fact*exp(-sep_sq/(wid*wid*2.0))*((sep_sq)/(wid*wid*wid) - 3.0/wid);
}

void FixDynamicWidthsCoMBPDoubtwoRobFtwo::CoM_Calculator()
{
  int i,ii,inum;
  int *ilist;
	double **x = atom->x;
  ...
  if (unallocated){
    deallocate();
    // // // fprintf(screen,"\nFixDynamicWidthsCoMBPDoubtwoRobFtwo allocating mu tau memory...\n");
    allocate();
    allocated = 1;
    unallocated = 0;
  }
...
void FixDynamicWidthsCoMBPDoubtwoRobFtwo::CalcBohmPot()
{
  // fprintf(screen,"\nCheckpoint 0");
...
int FixDynamicWidthsCoMBPDoubtwoRobFtwo::pack_forward_comm(int n, int *list, double *buf,
...
void FixDynamicWidthsCoMBPDoubtwoRobFtwo::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int FixDynamicWidthsCoMBPDoubtwoRobFtwo::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void FixDynamicWidthsCoMBPDoubtwoRobFtwo::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void FixDynamicWidthsCoMBPDoubtwoRobFtwo::allocate()
{
  // // fprintf(screen,"\nFixDynamicWidthsCoMBPDoubtwoRobFtwo::allocate()\n");
...
void FixDynamicWidthsCoMBPDoubtwoRobFtwo::deallocate()
{
  // // fprintf(screen,"\nFixDynamicWidthsCoMBPDoubtwoRobFtwo::deallocate()\n");
  delete [] mu;
  delete [] mu_all;
  delete [] tau;
  delete [] tau_all;
...
double FixDynamicWidthsCoMBPDoubtwoRobFtwo::compute_scalar()
{
