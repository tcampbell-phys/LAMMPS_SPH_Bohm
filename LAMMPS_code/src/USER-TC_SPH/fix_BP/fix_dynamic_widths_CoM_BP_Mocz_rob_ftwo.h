#ifdef FIX_CLASS
FixStyle(dynamic_widths_com_bp_mocz_rob_ftwo,FixDynamicWidthsCoMBPMoczRobFtwo)
#else
#ifndef LMP_FIX_DYNAMIC_WIDTHS_COM_BP_MOCZ_ROB_FTWO_H
#define LMP_FIX_DYNAMIC_WIDTHS_COM_BP_MOCZ_ROB_FTWO_H

#include "fix.h"

namespace LAMMPS_NS {
class FixDynamicWidthsCoMBPMoczRobFtwo : public Fix {
 public:
  FixDynamicWidthsCoMBPMoczRobFtwo(class LAMMPS *, int, char **);
  virtual ~FixDynamicWidthsCoMBPMoczRobFtwo();
  int setmask();
  virtual void init();
