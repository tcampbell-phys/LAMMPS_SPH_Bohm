#ifdef FIX_CLASS
FixStyle(dynamic_widths_com_bp_doub_rob_ftwo,FixDynamicWidthsCoMBPDoubRobFtwo)
#else
#ifndef LMP_FIX_DYNAMIC_WIDTHS_COM_BP_DOUB_ROB_FTWO_H
#define LMP_FIX_DYNAMIC_WIDTHS_COM_BP_DOUB_ROB_FTWO_H

#include "fix.h"

namespace LAMMPS_NS {
class FixDynamicWidthsCoMBPDoubRobFtwo : public Fix {
 public:
  FixDynamicWidthsCoMBPDoubRobFtwo(class LAMMPS *, int, char **);
  virtual ~FixDynamicWidthsCoMBPDoubRobFtwo();
  int setmask();
  virtual void init();
