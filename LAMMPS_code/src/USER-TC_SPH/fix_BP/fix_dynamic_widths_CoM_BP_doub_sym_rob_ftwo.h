#ifdef FIX_CLASS
FixStyle(dynamic_widths_com_bp_doub_sym_rob_ftwo,FixDynamicWidthsCoMBPDoubSymRobFtwo)
#else
#ifndef LMP_FIX_DYNAMIC_WIDTHS_COM_BP_DOUB_SYM_ROB_FTWO_H
#define LMP_FIX_DYNAMIC_WIDTHS_COM_BP_DOUB_SYM_ROB_FTWO_H

#include "fix.h"

namespace LAMMPS_NS {
class FixDynamicWidthsCoMBPDoubSymRobFtwo : public Fix {
 public:
  FixDynamicWidthsCoMBPDoubSymRobFtwo(class LAMMPS *, int, char **);
  virtual ~FixDynamicWidthsCoMBPDoubSymRobFtwo();
  int setmask();
  virtual void init();
