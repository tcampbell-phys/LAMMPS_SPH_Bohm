...
#include "fix_dynamic_widths_CoM_BP_rob_ftwo.h"
#include <cstring>
#include <mpi.h>
#include "group.h"
#include "modify.h"
...
FixDynamicWidthsCoMBPRobFtwo::FixDynamicWidthsCoMBPRobFtwo(LAMMPS *lmp, int narg, char **arg):
	Fix(lmp, narg, arg), mu(NULL), mu_all(NULL), tau(NULL), tau_all(NULL)
{
  ...
  // // fprintf(screen,"\nIn FixDynamicWidthsCoMBPRobFtwo with MPI_Allreduce and no commflag = 4 or 5");

  eflag = 0;
  eBohm = 0.0;
}

FixDynamicWidthsCoMBPRobFtwo::~FixDynamicWidthsCoMBPRobFtwo()
{
...
int FixDynamicWidthsCoMBPRobFtwo::setmask()
{
  int mask = 0;
...
void FixDynamicWidthsCoMBPRobFtwo::init()
{ 
...
void FixDynamicWidthsCoMBPRobFtwo::setup_pre_force(int)
{
  FixedPointIterator();
  CoM_Calculator();
}

void FixDynamicWidthsCoMBPRobFtwo::min_pre_force(int)
{
  FixedPointIterator();
  CoM_Calculator();
}
...
void FixDynamicWidthsCoMBPRobFtwo::setup_post_neighbor()
{
...
void FixDynamicWidthsCoMBPRobFtwo::post_neighbor()
{
  return;
}

void FixDynamicWidthsCoMBPRobFtwo::pre_force(int)
{
  FixedPointIterator();
  CoM_Calculator();
}

void FixDynamicWidthsCoMBPRobFtwo::end_of_step()
{
  // fprintf(screen,"\nFixDynamicWidthsCoMBPRobFtwo end_of_step");
  CalcBohmPot();
}

void FixDynamicWidthsCoMBPRobFtwo::FixedPointIterator()
{
...
double FixDynamicWidthsCoMBPRobFtwo::Gauss_Width_Deriv(double pre_fact, double wid, double sep_sq)
{
  return pre_fact*exp(-sep_sq/(wid*wid*2.0))*((sep_sq)/(wid*wid*wid) - 3.0/wid);
}

void FixDynamicWidthsCoMBPRobFtwo::CoM_Calculator()
{
  int i,ii,inum;
  int *ilist;
	double **x = atom->x;
  ...
  if (unallocated){
    deallocate();
    // // // fprintf(screen,"\nFixDynamicWidthsCoMBPRobFtwo allocating mu tau memory...\n");
    allocate();
    allocated = 1;
    unallocated = 0;
  }
...
void FixDynamicWidthsCoMBPRobFtwo::CalcBohmPot()
{
  // fprintf(screen,"\nCheckpoint 0");
  ...
  for (ii = 0; ii < inum; ii++) {
    ...
    // if (tag[i] == tag_targ) {
    //   fprintf(screen,"\nfix_dynamic_widths_CoM_BP_rob_ftwo tag_targ = %d",tag_targ);
...
int FixDynamicWidthsCoMBPRobFtwo::pack_forward_comm(int n, int *list, double *buf,
...
void FixDynamicWidthsCoMBPRobFtwo::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int FixDynamicWidthsCoMBPRobFtwo::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void FixDynamicWidthsCoMBPRobFtwo::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void FixDynamicWidthsCoMBPRobFtwo::allocate()
{
  // // fprintf(screen,"\nFixDynamicWidthsCoMBPRobFtwo::allocate()\n");
...
void FixDynamicWidthsCoMBPRobFtwo::deallocate()
{
  // // fprintf(screen,"\nFixDynamicWidthsCoMBPRobFtwo::deallocate()\n");
  delete [] mu;
  delete [] mu_all;
  delete [] tau;
  delete [] tau_all;
...
double FixDynamicWidthsCoMBPRobFtwo::compute_scalar()
{
