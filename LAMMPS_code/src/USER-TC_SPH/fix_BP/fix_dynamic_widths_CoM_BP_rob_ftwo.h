#ifdef FIX_CLASS
FixStyle(dynamic_widths_com_bp_rob_ftwo,FixDynamicWidthsCoMBPRobFtwo)
#else
#ifndef LMP_FIX_DYNAMIC_WIDTHS_COM_BP_ROB_FTWO_H
#define LMP_FIX_DYNAMIC_WIDTHS_COM_BP_ROB_FTWO_H

#include "fix.h"

namespace LAMMPS_NS {
class FixDynamicWidthsCoMBPRobFtwo : public Fix {
 public:
  FixDynamicWidthsCoMBPRobFtwo(class LAMMPS *, int, char **);
  virtual ~FixDynamicWidthsCoMBPRobFtwo();
  int setmask();
  virtual void init();
