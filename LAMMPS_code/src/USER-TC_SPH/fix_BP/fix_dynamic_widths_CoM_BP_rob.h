#ifdef FIX_CLASS
FixStyle(dynamic_widths_com_bp_rob,FixDynamicWidthsCoMBPRob)
#else
#ifndef LMP_FIX_DYNAMIC_WIDTHS_COM_BP_ROB_H
#define LMP_FIX_DYNAMIC_WIDTHS_COM_BP_ROB_H

#include "fix.h"

namespace LAMMPS_NS {
class FixDynamicWidthsCoMBPRob : public Fix {
 public:
  FixDynamicWidthsCoMBPRob(class LAMMPS *, int, char **);
  virtual ~FixDynamicWidthsCoMBPRob();
  int setmask();
  virtual void init();
