#ifdef FIX_CLASS
FixStyle(dynamic_widths_com_bp_doub_rob,FixDynamicWidthsCoMBPDoubRob)
#else
#ifndef LMP_FIX_DYNAMIC_WIDTHS_COM_BP_DOUB_ROB_H
#define LMP_FIX_DYNAMIC_WIDTHS_COM_BP_DOUB_ROB_H

#include "fix.h"

namespace LAMMPS_NS {
class FixDynamicWidthsCoMBPDoubRob : public Fix {
 public:
  FixDynamicWidthsCoMBPDoubRob(class LAMMPS *, int, char **);
  virtual ~FixDynamicWidthsCoMBPDoubRob();
  int setmask();
  virtual void init();
