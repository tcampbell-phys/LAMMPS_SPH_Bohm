#ifdef FIX_CLASS
FixStyle(dynamic_widths_com_bp_doubtwo_rob,FixDynamicWidthsCoMBPDoubtwoRob)
#else
#ifndef LMP_FIX_DYNAMIC_WIDTHS_COM_BP_DOUBTWO_ROB_H
#define LMP_FIX_DYNAMIC_WIDTHS_COM_BP_DOUBTWO_ROB_H

#include "fix.h"

namespace LAMMPS_NS {
class FixDynamicWidthsCoMBPDoubtwoRob : public Fix {
 public:
  FixDynamicWidthsCoMBPDoubtwoRob(class LAMMPS *, int, char **);
  virtual ~FixDynamicWidthsCoMBPDoubtwoRob();
  int setmask();
  virtual void init();
