#ifdef FIX_CLASS
FixStyle(dynamic_widths_com_bp_mocz_ftwo_diag,FixDynamicWidthsCoMBPMoczFtwoDiag)
#else
#ifndef LMP_FIX_DYNAMIC_WIDTHS_COM_BP_MOCZ_FTWO_DIAG_H
#define LMP_FIX_DYNAMIC_WIDTHS_COM_BP_MOCZ_FTWO_DIAG_H

#include "fix.h"

namespace LAMMPS_NS {
class FixDynamicWidthsCoMBPMoczFtwoDiag : public Fix {
 public:
  FixDynamicWidthsCoMBPMoczFtwoDiag(class LAMMPS *, int, char **);
  virtual ~FixDynamicWidthsCoMBPMoczFtwoDiag();
  int setmask();
  virtual void init();
