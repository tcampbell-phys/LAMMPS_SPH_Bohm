...
#include "fix_dynamic_widths_CoM_BP_doub_rob_ftwo.h"
#include <cstring>
#include <mpi.h>
#include "group.h"
#include "modify.h"
...
FixDynamicWidthsCoMBPDoubRobFtwo::FixDynamicWidthsCoMBPDoubRobFtwo(LAMMPS *lmp, int narg, char **arg):
	Fix(lmp, narg, arg), mu(NULL), mu_all(NULL), tau(NULL), tau_all(NULL)
{
  ...
  // // fprintf(screen,"\nIn FixDynamicWidthsCoMBPDoubRobFtwo with MPI_Allreduce and no commflag = 4 or 5");

  eflag = 0;
  eBohm = 0.0;
}

FixDynamicWidthsCoMBPDoubRobFtwo::~FixDynamicWidthsCoMBPDoubRobFtwo()
{
...
int FixDynamicWidthsCoMBPDoubRobFtwo::setmask()
{
  int mask = 0;
...
void FixDynamicWidthsCoMBPDoubRobFtwo::init()
{ 
...
void FixDynamicWidthsCoMBPDoubRobFtwo::setup_pre_force(int)
{
  FixedPointIterator();
  CoM_Calculator();
}

void FixDynamicWidthsCoMBPDoubRobFtwo::min_pre_force(int)
{
  FixedPointIterator();
  CoM_Calculator();
}
...
void FixDynamicWidthsCoMBPDoubRobFtwo::setup_post_neighbor()
{
...
void FixDynamicWidthsCoMBPDoubRobFtwo::post_neighbor()
{
  return;
}

void FixDynamicWidthsCoMBPDoubRobFtwo::pre_force(int)
{
  FixedPointIterator();
  CoM_Calculator();
}

void FixDynamicWidthsCoMBPDoubRobFtwo::end_of_step()
{
  // fprintf(screen,"\nFixDynamicWidthsCoMBPDoubRobFtwo end_of_step");
  CalcBohmPot();
}

void FixDynamicWidthsCoMBPDoubRobFtwo::FixedPointIterator()
{
...
double FixDynamicWidthsCoMBPDoubRobFtwo::Gauss_Width_Deriv(double pre_fact, double wid, double sep_sq)
{
  return pre_fact*exp(-sep_sq/(wid*wid*2.0))*((sep_sq)/(wid*wid*wid) - 3.0/wid);
}

void FixDynamicWidthsCoMBPDoubRobFtwo::CoM_Calculator()
{
  int i,ii,inum;
  int *ilist;
	double **x = atom->x;
  ...
  if (unallocated){
    deallocate();
    // // // fprintf(screen,"\nFixDynamicWidthsCoMBPDoubRobFtwo allocating mu tau memory...\n");
    allocate();
    allocated = 1;
    unallocated = 0;
  }
...
void FixDynamicWidthsCoMBPDoubRobFtwo::CalcBohmPot()
{
  // fprintf(screen,"\nCheckpoint 0");
  ...
  for (ii = 0; ii < inum; ii++) {
    ...
    // if (tag[i] == tag_targ) {
    //   fprintf(screen,"\nfix_dynamic_widths_CoM_BP_doub_rob_ftwo tag_targ = %d",tag_targ);
...
int FixDynamicWidthsCoMBPDoubRobFtwo::pack_forward_comm(int n, int *list, double *buf,
...
void FixDynamicWidthsCoMBPDoubRobFtwo::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int FixDynamicWidthsCoMBPDoubRobFtwo::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void FixDynamicWidthsCoMBPDoubRobFtwo::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void FixDynamicWidthsCoMBPDoubRobFtwo::allocate()
{
  // // fprintf(screen,"\nFixDynamicWidthsCoMBPDoubRobFtwo::allocate()\n");
...
void FixDynamicWidthsCoMBPDoubRobFtwo::deallocate()
{
  // // fprintf(screen,"\nFixDynamicWidthsCoMBPDoubRobFtwo::deallocate()\n");
  delete [] mu;
  delete [] mu_all;
  delete [] tau;
  delete [] tau_all;
...
double FixDynamicWidthsCoMBPDoubRobFtwo::compute_scalar()
{
