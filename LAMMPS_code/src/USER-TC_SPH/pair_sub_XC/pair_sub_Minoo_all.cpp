...
PairSubMinooAll::PairSubMinooAll(LAMMPS *lmp) : Pair(lmp)
{
...
PairSubMinooAll::~PairSubMinooAll()
{
  if (allocated) {
...
void PairSubMinooAll::compute(int eflag, int vflag)
{
...
void PairSubMinooAll::settings(int narg, char **arg)
{
...
void PairSubMinooAll::coeff(int narg, char **arg)
{
...
void PairSubMinooAll::init_style()
{
...
double PairSubMinooAll::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairSubMinooAll::write_restart(FILE *fp)
{
...
void PairSubMinooAll::read_restart(FILE *fp)
{
...
void PairSubMinooAll::write_restart_settings(FILE *fp)
{
...
void PairSubMinooAll::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
// double PairSubMinooAll::single(int i, int j, int /*itype*/, int /*jtype*/,
//                             double rsq,
//                             double targ_temp)
// {
...
void *PairSubMinooAll::extract(const char *str, int &dim)
{
