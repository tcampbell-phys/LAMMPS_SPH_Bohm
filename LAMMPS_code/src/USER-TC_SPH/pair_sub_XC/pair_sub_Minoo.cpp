...
PairSubMinoo::PairSubMinoo(LAMMPS *lmp) : Pair(lmp)
{
...
void PairSubMinoo::compute(int eflag, int vflag)
{
...
void PairSubMinoo::coeff(int narg, char **arg)
{
...
double PairSubMinoo::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairSubMinoo::write_restart(FILE *fp)
{
...
void PairSubMinoo::read_restart(FILE *fp)
{
...
void PairSubMinoo::write_restart_settings(FILE *fp)
{
...
void PairSubMinoo::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
// double PairSubMinoo::single(int i, int j, int /*itype*/, int /*jtype*/,
//                             double rsq,
//                             double targ_temp)
// {
...
void *PairSubMinoo::extract(const char *str, int &dim)
{
