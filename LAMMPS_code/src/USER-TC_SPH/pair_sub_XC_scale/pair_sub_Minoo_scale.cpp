...
#include "pair_sub_Minoo_scale.h"
#include "domain.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
...
PairSubMinooScale::PairSubMinooScale(LAMMPS *lmp) : Pair(lmp)
{
...
PairSubMinooScale::~PairSubMinooScale()
{
  if (allocated) {
...
void PairSubMinooScale::compute(int eflag, int vflag)
{
...
void PairSubMinooScale::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairSubMinooScale::settings(int narg, char **arg)
{
...
void PairSubMinooScale::coeff(int narg, char **arg)
{
...
void PairSubMinooScale::init_style()
{
...
double PairSubMinooScale::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairSubMinooScale::write_restart(FILE *fp)
{
...
void PairSubMinooScale::read_restart(FILE *fp)
{
...
void PairSubMinooScale::write_restart_settings(FILE *fp)
{
...
void PairSubMinooScale::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
// double PairSubMinooScale::single(int i, int j, int /*itype*/, int /*jtype*/,
//                             double rsq,
//                             double targ_temp)
// {
...
void *PairSubMinooScale::extract(const char *str, int &dim)
{
