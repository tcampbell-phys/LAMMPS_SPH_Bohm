...
KSpaceStyle(ewald_traj,EwaldTraj)

#else

#ifndef LMP_EWALD_TRAJ_H
#define LMP_EWALD_TRAJ_H

#include "kspace.h"

namespace LAMMPS_NS {

class EwaldTraj : public KSpace {
 public:
  EwaldTraj(class LAMMPS *);
  virtual ~EwaldTraj();
  void init();
  void setup();
...
E: Cannot use EwaldTraj with 2d simulation

The kspace style ewald cannot be used in 2d simulations.  You can use
2d EwaldTraj in a 3d simulation; see the kspace_modify command.

E: Kspace style requires atom attribute q

The atom style defined does not have these attributes.

E: Cannot use non-periodic boundaries with EwaldTraj

For kspace style ewald, all 3 dimensions must have periodic boundaries
unless you use the kspace_modify command to define a 2d slab with a
non-periodic z dimension.

E: Incorrect boundaries with slab EwaldTraj

Must have periodic x,y dimensions and non-periodic z dimension to use
2d slab option with EwaldTraj.

E: Cannot (yet) use EwaldTraj with triclinic box and slab correction
