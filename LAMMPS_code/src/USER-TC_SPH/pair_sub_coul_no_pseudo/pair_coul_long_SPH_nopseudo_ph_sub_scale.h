...
PairStyle(coul/long/SPH_nopseudo_ph_sub_scale,PairCoulLongNopseudoSPHphsubScale)

#else

#ifndef LMP_PAIR_COUL_LONG_NOPSEUDO_SPH_PH_SUB_SCALE_H
#define LMP_PAIR_COUL_LONG_NOPSEUDO_SPH_PH_SUB_SCALE_H

#include "pair.h"

namespace LAMMPS_NS {

class PairCoulLongNopseudoSPHphsubScale : public Pair {
 public:
  PairCoulLongNopseudoSPHphsubScale(class LAMMPS *);
  ~PairCoulLongNopseudoSPHphsubScale();
