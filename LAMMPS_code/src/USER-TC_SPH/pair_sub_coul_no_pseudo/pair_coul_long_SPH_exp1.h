...
PairStyle(coul/long/SPH_exp_one,PairCoulLongNopseudoSPHexp)

#else

#ifndef LMP_PAIR_COUL_LONG_NOPSEUDO_SPH_EXP_ONE_H
#define LMP_PAIR_COUL_LONG_NOPSEUDO_SPH_EXP_ONE_H

#include "pair.h"

namespace LAMMPS_NS {

class PairCoulLongNopseudoSPHexp : public Pair {
 public:
  PairCoulLongNopseudoSPHexp(class LAMMPS *);
  ~PairCoulLongNopseudoSPHexp();
