...
PairStyle(coul/long/SPH_nopseudo_ph_sub_ftwo,PairCoulLongNopseudoSPHphsubFtwo)

#else

#ifndef LMP_PAIR_COUL_LONG_NOPSEUDO_SPH_PH_SUB_FTWO_H
#define LMP_PAIR_COUL_LONG_NOPSEUDO_SPH_PH_SUB_FTWO_H

#include "pair.h"

namespace LAMMPS_NS {

class PairCoulLongNopseudoSPHphsubFtwo : public Pair {
 public:
  PairCoulLongNopseudoSPHphsubFtwo(class LAMMPS *);
  ~PairCoulLongNopseudoSPHphsubFtwo();
