...
#include "pair_coul_long_SPH_nopseudo_ph_sub_F2.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include "group.h"
...
PairCoulLongNopseudoSPHphsubFtwo::PairCoulLongNopseudoSPHphsubFtwo(LAMMPS *lmp) : Pair(lmp)
{
...
PairCoulLongNopseudoSPHphsubFtwo::~PairCoulLongNopseudoSPHphsubFtwo()
{
  if (copymode) return;
...
void PairCoulLongNopseudoSPHphsubFtwo::compute(int eflag, int vflag)
{
  ...
  double rho_i, rho_j, omega_i, fact_i;
      ...
      if (rsq < cut_coulsq) {
        ...
        if (jtype != ion_species){
          ...
          if (itype != ion_species){
            ...
            ji_fact = hm2_j*m_gauss_ji*(theta_coul[j]+theta_coul_ei[j])*dens_factor_ji;
            ...
            if (newton_pair || j < nlocal) {
              ...
              ij_fact = hm2_i*m_gauss_ij*(theta_coul[i]+theta_coul_ei[i])*dens_factor_ij;
...
void PairCoulLongNopseudoSPHphsubFtwo::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairCoulLongNopseudoSPHphsubFtwo::settings(int narg, char **arg)
{
...
void PairCoulLongNopseudoSPHphsubFtwo::coeff(int narg, char **arg)
{
...
void PairCoulLongNopseudoSPHphsubFtwo::init_style()
{
  if (!atom->q_flag)
...
double PairCoulLongNopseudoSPHphsubFtwo::init_one(int i, int j)
{
  scale[j][i] = scale[i][j];
...
void PairCoulLongNopseudoSPHphsubFtwo::write_restart(FILE *fp)
{
...
void PairCoulLongNopseudoSPHphsubFtwo::read_restart(FILE *fp)
{
...
void PairCoulLongNopseudoSPHphsubFtwo::write_restart_settings(FILE *fp)
{
...
void PairCoulLongNopseudoSPHphsubFtwo::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
// double PairCoulLongNopseudoSPHphsubFtwo::single(int i, int j, int /*itype*/, int /*jtype*/,
//                             double rsq,
...
void *PairCoulLongNopseudoSPHphsubFtwo::extract(const char *str, int &dim)
{
...
int PairCoulLongNopseudoSPHphsubFtwo::pack_forward_comm(int n, int *list, double *buf,
...
void PairCoulLongNopseudoSPHphsubFtwo::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairCoulLongNopseudoSPHphsubFtwo::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairCoulLongNopseudoSPHphsubFtwo::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
