...
#include "fix_dynamic_widths_CoM_BP_Mocz_rob_ftwo.h"
...
class PairHybrid : public Pair {
  ...
  friend class FixDynamicWidthsCoMBPMoczRobFtwo;
  friend class FixDynamicWidthsCoMBPMoczFtwoDiag;
  friend class FixDynamicWidthsCoMBPMoczRobFtwoDiag;
  friend class FixDynamicWidthsCoMBPMoczRob;
  friend class FixDynamicWidthsCoMBPRob;
  friend class FixDynamicWidthsCoMBPRobFtwo;
  friend class FixDynamicWidthsCoMBPDoubRobFtwo;
  friend class FixDynamicWidthsCoMBPDoubSymRobFtwo;
  friend class FixDynamicWidthsCoMBPDoubRob;
  friend class FixDynamicWidthsCoMBPDoubtwoRobFtwo;
  friend class FixDynamicWidthsCoMBPDoubtwoRob;
 public:
