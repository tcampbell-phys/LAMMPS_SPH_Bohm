...
PairSubMinooTraj::PairSubMinooTraj(LAMMPS *lmp) : Pair(lmp)
{
...
PairSubMinooTraj::~PairSubMinooTraj()
{
  if (allocated) {
...
void PairSubMinooTraj::compute(int eflag, int vflag)
{
...
void PairSubMinooTraj::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairSubMinooTraj::settings(int narg, char **arg)
{
...
void PairSubMinooTraj::coeff(int narg, char **arg)
{
...
void PairSubMinooTraj::init_style()
{
...
double PairSubMinooTraj::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairSubMinooTraj::write_restart(FILE *fp)
{
...
void PairSubMinooTraj::read_restart(FILE *fp)
{
...
void PairSubMinooTraj::write_restart_settings(FILE *fp)
{
...
void PairSubMinooTraj::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
// double PairSubMinooTraj::single(int i, int j, int /*itype*/, int /*jtype*/,
//                             double rsq,
//                             double targ_temp)
// {
...
void *PairSubMinooTraj::extract(const char *str, int &dim)
{
