...
PairStyle(coul/long/SPH_nopseudo_ph,PairCoulLongNopseudoSPHph)

#else

#ifndef LMP_PAIR_COUL_LONG_NOPSEUDO_SPH_PH_H
#define LMP_PAIR_COUL_LONG_NOPSEUDO_SPH_PH_H

#include "pair.h"

namespace LAMMPS_NS {

class PairCoulLongNopseudoSPHph : public Pair {
 public:
  PairCoulLongNopseudoSPHph(class LAMMPS *);
  ~PairCoulLongNopseudoSPHph();
