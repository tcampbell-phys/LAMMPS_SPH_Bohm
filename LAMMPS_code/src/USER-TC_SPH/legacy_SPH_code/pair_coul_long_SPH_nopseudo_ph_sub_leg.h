...
PairStyle(coul/long/SPH_nopseudo_ph_sub,PairCoulLongNopseudoSPHphsub)

#else

#ifndef LMP_PAIR_COUL_LONG_NOPSEUDO_SPH_PH_SUB_H
#define LMP_PAIR_COUL_LONG_NOPSEUDO_SPH_PH_SUB_H

#include "pair.h"

namespace LAMMPS_NS {

class PairCoulLongNopseudoSPHphsub : public Pair {
 public:
  PairCoulLongNopseudoSPHphsub(class LAMMPS *);
  ~PairCoulLongNopseudoSPHphsub();
