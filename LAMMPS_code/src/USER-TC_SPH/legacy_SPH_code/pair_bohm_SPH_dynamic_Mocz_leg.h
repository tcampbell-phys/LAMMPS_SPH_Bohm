...
PairStyle(bohm_SPH_dynamic_Mocz_leg,PairBohmSPHDynamicMoczLeg)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_LEG_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_LEG_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczLeg : public Pair {
 public:
  PairBohmSPHDynamicMoczLeg(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczLeg();
