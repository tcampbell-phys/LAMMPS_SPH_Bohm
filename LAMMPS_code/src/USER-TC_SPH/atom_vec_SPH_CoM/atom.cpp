...
Atom::Atom(LAMMPS *lmp) : Pointers(lmp)
{
  ...
  dx_rho_SPH = dy_rho_SPH = dz_rho_SPH = NULL;

  // Bohm SPH CoM coords:
  x_COM = y_COM = z_COM = NULL;
  vx_COM = vy_COM = vz_COM = NULL;
...
Atom::~Atom()
{
  ...
  memory->destroy(dx_rho_SPH);
  memory->destroy(dy_rho_SPH);
  memory->destroy(dz_rho_SPH);
  ...
  memory->destroy(y_COM);
  memory->destroy(z_COM);
...
void *Atom::extract(char *name)
{
  ...
  if (strcmp(name,"dx_rho_SPH") == 0) return (void *) dx_rho_SPH;
  if (strcmp(name,"dy_rho_SPH") == 0) return (void *) dy_rho_SPH;
  if (strcmp(name,"dz_rho_SPH") == 0) return (void *) dz_rho_SPH;
  ...
  //Bohm SPH CoM:
  if (strcmp(name,"x_COM") == 0) return (void *) x_COM;
  if (strcmp(name,"y_COM") == 0) return (void *) y_COM;
  if (strcmp(name,"z_COM") == 0) return (void *) z_COM;
  if (strcmp(name,"vx_COM") == 0) return (void *) vx_COM;
  if (strcmp(name,"vy_COM") == 0) return (void *) vy_COM;
  if (strcmp(name,"vz_COM") == 0) return (void *) vz_COM;
