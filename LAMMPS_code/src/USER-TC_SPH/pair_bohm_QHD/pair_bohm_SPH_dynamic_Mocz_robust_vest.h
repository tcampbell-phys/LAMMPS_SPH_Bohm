...
PairStyle(bohm_SPH_dynamic_Mocz_rob_vest,PairBohmSPHDynamicMoczRobustVest)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_VEST_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_VEST_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczRobustVest : public Pair {
 public:
  PairBohmSPHDynamicMoczRobustVest(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczRobustVest();
