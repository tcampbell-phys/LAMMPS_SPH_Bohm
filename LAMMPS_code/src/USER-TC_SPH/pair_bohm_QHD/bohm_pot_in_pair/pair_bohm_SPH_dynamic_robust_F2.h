...
PairStyle(bohm_SPH_dynamic_rob_ftwo,PairBohmSPHDynamicRobustFtwo)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_ROBUST_FTWO_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_ROBUST_FTWO_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicRobustFtwo : public Pair {
 public:
  PairBohmSPHDynamicRobustFtwo(class LAMMPS *);
  virtual ~PairBohmSPHDynamicRobustFtwo();
