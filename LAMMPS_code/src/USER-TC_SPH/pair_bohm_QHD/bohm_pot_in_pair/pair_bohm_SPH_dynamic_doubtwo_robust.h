...
PairStyle(bohm_SPH_dynamic_doubtwo_rob,PairBohmSPHDynamicDoubtwoRobust)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_DOUBTWO_ROBUST_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_DOUBTWO_ROBUST_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicDoubtwoRobust : public Pair {
 public:
  PairBohmSPHDynamicDoubtwoRobust(class LAMMPS *);
  virtual ~PairBohmSPHDynamicDoubtwoRobust();
