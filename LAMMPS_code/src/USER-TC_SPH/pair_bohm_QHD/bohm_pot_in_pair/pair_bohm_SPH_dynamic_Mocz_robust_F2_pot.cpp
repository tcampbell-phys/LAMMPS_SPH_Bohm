...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_Mocz_robust_F2_pot.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicMoczRobustFtwoPot::PairBohmSPHDynamicMoczRobustFtwoPot(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicMoczRobustFtwoPot::~PairBohmSPHDynamicMoczRobustFtwoPot()
{
  if (allocated) {
...
void PairBohmSPHDynamicMoczRobustFtwoPot::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicMoczRobustFtwoPot::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicMoczRobustFtwoPot::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicMoczRobustFtwoPot::init_style()
{
...
double PairBohmSPHDynamicMoczRobustFtwoPot::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicMoczRobustFtwoPot::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoPot::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoPot::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoPot::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicMoczRobustFtwoPot::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicMoczRobustFtwoPot::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicMoczRobustFtwoPot::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicMoczRobustFtwoPot::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicMoczRobustFtwoPot::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
