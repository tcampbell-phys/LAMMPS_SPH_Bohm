...
PairStyle(bohm_SPH_dynamic_doub_rob,PairBohmSPHDynamicDoubRobust)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_DOUB_ROBUST_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_DOUB_ROBUST_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicDoubRobust : public Pair {
 public:
  PairBohmSPHDynamicDoubRobust(class LAMMPS *);
  virtual ~PairBohmSPHDynamicDoubRobust();
