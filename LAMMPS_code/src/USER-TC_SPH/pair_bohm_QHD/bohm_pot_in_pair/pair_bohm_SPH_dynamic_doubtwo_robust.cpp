...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_doubtwo_robust.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicDoubtwoRobust::PairBohmSPHDynamicDoubtwoRobust(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicDoubtwoRobust::~PairBohmSPHDynamicDoubtwoRobust()
{
  if (allocated) {
...
void PairBohmSPHDynamicDoubtwoRobust::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicDoubtwoRobust::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicDoubtwoRobust::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicDoubtwoRobust::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicDoubtwoRobust::init_style()
{
...
double PairBohmSPHDynamicDoubtwoRobust::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicDoubtwoRobust::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicDoubtwoRobust::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicDoubtwoRobust::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicDoubtwoRobust::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicDoubtwoRobust::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicDoubtwoRobust::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicDoubtwoRobust::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicDoubtwoRobust::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicDoubtwoRobust::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
