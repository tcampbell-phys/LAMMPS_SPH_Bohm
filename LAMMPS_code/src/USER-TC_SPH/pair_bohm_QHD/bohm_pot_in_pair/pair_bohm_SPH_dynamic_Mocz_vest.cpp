...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_Mocz_vest.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicMoczVest::PairBohmSPHDynamicMoczVest(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicMoczVest::~PairBohmSPHDynamicMoczVest()
{
  if (allocated) {
...
void PairBohmSPHDynamicMoczVest::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicMoczVest::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicMoczVest::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicMoczVest::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicMoczVest::init_style()
{
...
double PairBohmSPHDynamicMoczVest::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicMoczVest::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczVest::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczVest::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicMoczVest::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicMoczVest::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicMoczVest::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicMoczVest::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicMoczVest::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicMoczVest::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
