...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_robust_F2.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicRobustFtwo::PairBohmSPHDynamicRobustFtwo(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicRobustFtwo::~PairBohmSPHDynamicRobustFtwo()
{
  if (allocated) {
...
void PairBohmSPHDynamicRobustFtwo::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicRobustFtwo::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicRobustFtwo::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicRobustFtwo::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicRobustFtwo::init_style()
{
...
double PairBohmSPHDynamicRobustFtwo::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicRobustFtwo::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicRobustFtwo::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicRobustFtwo::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicRobustFtwo::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicRobustFtwo::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicRobustFtwo::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicRobustFtwo::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicRobustFtwo::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicRobustFtwo::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
