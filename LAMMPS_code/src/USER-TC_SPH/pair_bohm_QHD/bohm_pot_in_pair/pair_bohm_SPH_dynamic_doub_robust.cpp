...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_doub_robust.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicDoubRobust::PairBohmSPHDynamicDoubRobust(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicDoubRobust::~PairBohmSPHDynamicDoubRobust()
{
  if (allocated) {
...
void PairBohmSPHDynamicDoubRobust::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicDoubRobust::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicDoubRobust::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicDoubRobust::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicDoubRobust::init_style()
{
...
double PairBohmSPHDynamicDoubRobust::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicDoubRobust::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicDoubRobust::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicDoubRobust::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicDoubRobust::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicDoubRobust::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicDoubRobust::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicDoubRobust::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicDoubRobust::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicDoubRobust::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
