...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_Mocz_robust_F2_vest.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicMoczRobustFtwoVest::PairBohmSPHDynamicMoczRobustFtwoVest(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicMoczRobustFtwoVest::~PairBohmSPHDynamicMoczRobustFtwoVest()
{
  if (allocated) {
...
void PairBohmSPHDynamicMoczRobustFtwoVest::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicMoczRobustFtwoVest::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicMoczRobustFtwoVest::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicMoczRobustFtwoVest::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicMoczRobustFtwoVest::init_style()
{
...
double PairBohmSPHDynamicMoczRobustFtwoVest::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicMoczRobustFtwoVest::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoVest::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoVest::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoVest::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicMoczRobustFtwoVest::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicMoczRobustFtwoVest::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicMoczRobustFtwoVest::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicMoczRobustFtwoVest::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicMoczRobustFtwoVest::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
