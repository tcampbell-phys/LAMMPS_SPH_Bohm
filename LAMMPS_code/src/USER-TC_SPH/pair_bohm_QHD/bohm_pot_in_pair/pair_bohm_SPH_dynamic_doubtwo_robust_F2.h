...
PairStyle(bohm_SPH_dynamic_doubtwo_rob_ftwo,PairBohmSPHDynamicDoubtwoRobustFtwo)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_DOUBTWO_ROBUST_FTWO_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_DOUBTWO_ROBUST_FTWO_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicDoubtwoRobustFtwo : public Pair {
 public:
  PairBohmSPHDynamicDoubtwoRobustFtwo(class LAMMPS *);
  virtual ~PairBohmSPHDynamicDoubtwoRobustFtwo();
