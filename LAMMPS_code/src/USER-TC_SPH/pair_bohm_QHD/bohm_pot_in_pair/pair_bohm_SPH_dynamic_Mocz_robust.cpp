...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_Mocz_robust.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicMoczRobust::PairBohmSPHDynamicMoczRobust(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicMoczRobust::~PairBohmSPHDynamicMoczRobust()
{
  if (allocated) {
...
void PairBohmSPHDynamicMoczRobust::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicMoczRobust::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicMoczRobust::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicMoczRobust::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicMoczRobust::init_style()
{
...
double PairBohmSPHDynamicMoczRobust::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicMoczRobust::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobust::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobust::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobust::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicMoczRobust::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicMoczRobust::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicMoczRobust::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicMoczRobust::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicMoczRobust::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
