...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_Mocz_F2.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicMoczFtwo::PairBohmSPHDynamicMoczFtwo(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicMoczFtwo::~PairBohmSPHDynamicMoczFtwo()
{
  if (allocated) {
...
void PairBohmSPHDynamicMoczFtwo::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicMoczFtwo::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicMoczFtwo::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicMoczFtwo::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicMoczFtwo::init_style()
{
...
double PairBohmSPHDynamicMoczFtwo::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicMoczFtwo::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczFtwo::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczFtwo::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicMoczFtwo::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicMoczFtwo::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicMoczFtwo::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicMoczFtwo::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicMoczFtwo::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicMoczFtwo::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
