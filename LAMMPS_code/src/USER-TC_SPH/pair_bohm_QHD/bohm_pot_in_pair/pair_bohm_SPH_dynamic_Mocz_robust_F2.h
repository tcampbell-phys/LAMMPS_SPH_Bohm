...
PairStyle(bohm_SPH_dynamic_Mocz_rob_ftwo,PairBohmSPHDynamicMoczRobustFtwo)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FTWO_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FTWO_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczRobustFtwo : public Pair {
 public:
  PairBohmSPHDynamicMoczRobustFtwo(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczRobustFtwo();
