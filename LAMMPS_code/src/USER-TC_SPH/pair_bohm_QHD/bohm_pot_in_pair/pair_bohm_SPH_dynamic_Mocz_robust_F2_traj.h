...
PairStyle(bohm_SPH_dynamic_Mocz_rob_ftwo_traj,PairBohmSPHDynamicMoczRobustFtwoTraj)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FTWO_TRAJ_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FTWO_TRAJ_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczRobustFtwoTraj : public Pair {
 public:
  PairBohmSPHDynamicMoczRobustFtwoTraj(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczRobustFtwoTraj();
