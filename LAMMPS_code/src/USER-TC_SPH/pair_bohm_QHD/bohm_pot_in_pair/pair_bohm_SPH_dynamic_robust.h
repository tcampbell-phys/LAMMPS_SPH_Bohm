...
PairStyle(bohm_SPH_dynamic_rob,PairBohmSPHDynamicRobust)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_ROBUST_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_ROBUST_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicRobust : public Pair {
 public:
  PairBohmSPHDynamicRobust(class LAMMPS *);
  virtual ~PairBohmSPHDynamicRobust();
