...
PairStyle(bohm_SPH_dynamic_Mocz_ftwo,PairBohmSPHDynamicMoczFtwo)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_FTWO_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_FTWO_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczFtwo : public Pair {
 public:
  PairBohmSPHDynamicMoczFtwo(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczFtwo();
