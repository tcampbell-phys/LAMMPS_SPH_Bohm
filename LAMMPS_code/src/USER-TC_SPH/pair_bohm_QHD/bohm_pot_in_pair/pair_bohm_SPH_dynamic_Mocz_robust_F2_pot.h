...
PairStyle(bohm_SPH_dynamic_Mocz_rob_ftwo_pot,PairBohmSPHDynamicMoczRobustFtwoPot)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FTWO_POT_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FTWO_POT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczRobustFtwoPot : public Pair {
 public:
  PairBohmSPHDynamicMoczRobustFtwoPot(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczRobustFtwoPot();
