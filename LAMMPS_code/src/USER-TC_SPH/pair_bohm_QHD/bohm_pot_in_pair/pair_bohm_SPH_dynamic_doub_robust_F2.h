...
PairStyle(bohm_SPH_dynamic_doub_rob_ftwo,PairBohmSPHDynamicDoubRobustFtwo)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_DOUB_ROBUST_FTWO_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_DOUB_ROBUST_FTWO_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicDoubRobustFtwo : public Pair {
 public:
  PairBohmSPHDynamicDoubRobustFtwo(class LAMMPS *);
  virtual ~PairBohmSPHDynamicDoubRobustFtwo();
