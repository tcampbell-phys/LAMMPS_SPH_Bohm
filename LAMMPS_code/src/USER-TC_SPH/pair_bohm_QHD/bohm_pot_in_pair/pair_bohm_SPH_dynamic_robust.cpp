...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_robust.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicRobust::PairBohmSPHDynamicRobust(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicRobust::~PairBohmSPHDynamicRobust()
{
  if (allocated) {
...
void PairBohmSPHDynamicRobust::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicRobust::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicRobust::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicRobust::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicRobust::init_style()
{
...
double PairBohmSPHDynamicRobust::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicRobust::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicRobust::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicRobust::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicRobust::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicRobust::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicRobust::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicRobust::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicRobust::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicRobust::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
