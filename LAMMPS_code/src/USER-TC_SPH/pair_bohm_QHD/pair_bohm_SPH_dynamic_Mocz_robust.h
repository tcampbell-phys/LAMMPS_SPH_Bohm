...
PairStyle(bohm_SPH_dynamic_Mocz_rob,PairBohmSPHDynamicMoczRobust)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczRobust : public Pair {
 public:
  PairBohmSPHDynamicMoczRobust(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczRobust();
