...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_Mocz_robust_F2_fix.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicMoczRobustFtwoFix::PairBohmSPHDynamicMoczRobustFtwoFix(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicMoczRobustFtwoFix::~PairBohmSPHDynamicMoczRobustFtwoFix()
{
  if (allocated) {
...
void PairBohmSPHDynamicMoczRobustFtwoFix::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicMoczRobustFtwoFix::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicMoczRobustFtwoFix::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicMoczRobustFtwoFix::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicMoczRobustFtwoFix::init_style()
{
...
double PairBohmSPHDynamicMoczRobustFtwoFix::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicMoczRobustFtwoFix::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoFix::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoFix::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoFix::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicMoczRobustFtwoFix::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicMoczRobustFtwoFix::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicMoczRobustFtwoFix::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicMoczRobustFtwoFix::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicMoczRobustFtwoFix::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
