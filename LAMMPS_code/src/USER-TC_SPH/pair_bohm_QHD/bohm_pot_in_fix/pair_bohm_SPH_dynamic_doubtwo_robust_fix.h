...
PairStyle(bohm_SPH_dynamic_doubtwo_rob_fix,PairBohmSPHDynamicDoubtwoRobustFix)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_DOUBTWO_ROBUST_FIX_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_DOUBTWO_ROBUST_FIX_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicDoubtwoRobustFix : public Pair {
 public:
  PairBohmSPHDynamicDoubtwoRobustFix(class LAMMPS *);
  virtual ~PairBohmSPHDynamicDoubtwoRobustFix();
