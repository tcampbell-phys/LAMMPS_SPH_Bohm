...
PairStyle(bohm_SPH_dynamic_doub_rob_ftwo_fix,PairBohmSPHDynamicDoubRobustFtwoFix)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_DOUB_ROBUST_FTWO_FIX_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_DOUB_ROBUST_FTWO_FIX_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicDoubRobustFtwoFix : public Pair {
 public:
  PairBohmSPHDynamicDoubRobustFtwoFix(class LAMMPS *);
  virtual ~PairBohmSPHDynamicDoubRobustFtwoFix();
