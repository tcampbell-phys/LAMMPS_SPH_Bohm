#ifdef FIX_CLASS
FixStyle(dynamic_widths_com_bp_mocz_rob,FixDynamicWidthsCoMBPMoczRob)
#else
#ifndef LMP_FIX_DYNAMIC_WIDTHS_COM_BP_MOCZ_ROB_H
#define LMP_FIX_DYNAMIC_WIDTHS_COM_BP_MOCZ_ROB_H

#include "fix.h"

namespace LAMMPS_NS {
class FixDynamicWidthsCoMBPMoczRob : public Fix {
 public:
  FixDynamicWidthsCoMBPMoczRob(class LAMMPS *, int, char **);
  virtual ~FixDynamicWidthsCoMBPMoczRob();
  int setmask();
  virtual void init();
