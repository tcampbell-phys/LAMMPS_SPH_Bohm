...
PairStyle(bohm_SPH_dynamic_rob_ftwo_fix,PairBohmSPHDynamicRobustFtwoFix)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_ROBUST_FTWO_FIX_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_ROBUST_FTWO_FIX_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicRobustFtwoFix : public Pair {
 public:
  PairBohmSPHDynamicRobustFtwoFix(class LAMMPS *);
  virtual ~PairBohmSPHDynamicRobustFtwoFix();
