...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_doub_robust_fix.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicDoubRobustFix::PairBohmSPHDynamicDoubRobustFix(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicDoubRobustFix::~PairBohmSPHDynamicDoubRobustFix()
{
  if (allocated) {
...
void PairBohmSPHDynamicDoubRobustFix::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicDoubRobustFix::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicDoubRobustFix::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicDoubRobustFix::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicDoubRobustFix::init_style()
{
...
double PairBohmSPHDynamicDoubRobustFix::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicDoubRobustFix::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicDoubRobustFix::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicDoubRobustFix::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicDoubRobustFix::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicDoubRobustFix::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicDoubRobustFix::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicDoubRobustFix::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicDoubRobustFix::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicDoubRobustFix::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
