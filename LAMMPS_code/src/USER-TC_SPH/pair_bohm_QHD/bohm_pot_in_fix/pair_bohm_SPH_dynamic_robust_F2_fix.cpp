...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_robust_F2_fix.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicRobustFtwoFix::PairBohmSPHDynamicRobustFtwoFix(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicRobustFtwoFix::~PairBohmSPHDynamicRobustFtwoFix()
{
  if (allocated) {
...
void PairBohmSPHDynamicRobustFtwoFix::compute(int eflag, int vflag)
{
  ...
  for (ii = 0; ii < inum; ii++) {
    ...
    // if (tag[i] == tag_targ) {
    //   fprintf(screen,"\npair_bohm_SPH_dynamic_robust_F2_fix tag_targ = %d",tag_targ);
    //   fprintf(screen,"\nPxx = %16.16f",Pxx[i]);
    //   fprintf(screen,"\nPxy = %16.16f",Pxy[i]);
    //   fprintf(screen,"\nPxz = %16.16f",Pxz[i]);
    //   fprintf(screen,"\nPyy = %16.16f",Pyy[i]);
...
void PairBohmSPHDynamicRobustFtwoFix::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicRobustFtwoFix::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicRobustFtwoFix::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicRobustFtwoFix::init_style()
{
...
double PairBohmSPHDynamicRobustFtwoFix::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicRobustFtwoFix::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicRobustFtwoFix::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicRobustFtwoFix::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicRobustFtwoFix::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicRobustFtwoFix::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicRobustFtwoFix::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicRobustFtwoFix::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicRobustFtwoFix::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicRobustFtwoFix::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
