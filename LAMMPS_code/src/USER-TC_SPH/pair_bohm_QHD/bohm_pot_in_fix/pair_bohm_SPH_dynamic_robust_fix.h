...
PairStyle(bohm_SPH_dynamic_rob_fix,PairBohmSPHDynamicRobustFix)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_ROBUST_FIX_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_ROBUST_FIX_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicRobustFix : public Pair {
 public:
  PairBohmSPHDynamicRobustFix(class LAMMPS *);
  virtual ~PairBohmSPHDynamicRobustFix();
