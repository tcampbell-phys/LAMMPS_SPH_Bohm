...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_doubtwo_robust_fix.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicDoubtwoRobustFix::PairBohmSPHDynamicDoubtwoRobustFix(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicDoubtwoRobustFix::~PairBohmSPHDynamicDoubtwoRobustFix()
{
  if (allocated) {
...
void PairBohmSPHDynamicDoubtwoRobustFix::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicDoubtwoRobustFix::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicDoubtwoRobustFix::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicDoubtwoRobustFix::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicDoubtwoRobustFix::init_style()
{
...
double PairBohmSPHDynamicDoubtwoRobustFix::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicDoubtwoRobustFix::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicDoubtwoRobustFix::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicDoubtwoRobustFix::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicDoubtwoRobustFix::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicDoubtwoRobustFix::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicDoubtwoRobustFix::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicDoubtwoRobustFix::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicDoubtwoRobustFix::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicDoubtwoRobustFix::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
