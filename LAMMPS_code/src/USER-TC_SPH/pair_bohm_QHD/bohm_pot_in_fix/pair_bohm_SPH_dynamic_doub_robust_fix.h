...
PairStyle(bohm_SPH_dynamic_doub_rob_fix,PairBohmSPHDynamicDoubRobustFix)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_DOUB_ROBUST_FIX_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_DOUB_ROBUST_FIX_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicDoubRobustFix : public Pair {
 public:
  PairBohmSPHDynamicDoubRobustFix(class LAMMPS *);
  virtual ~PairBohmSPHDynamicDoubRobustFix();
