...
PairStyle(bohm_SPH_dynamic_Mocz_rob_ftwo_fix,PairBohmSPHDynamicMoczRobustFtwoFix)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FTWO_FIX_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FTWO_FIX_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczRobustFtwoFix : public Pair {
 public:
  PairBohmSPHDynamicMoczRobustFtwoFix(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczRobustFtwoFix();
