...
PairStyle(bohm_SPH_dynamic_doubtwo_rob_ftwo_fix,PairBohmSPHDynamicDoubtwoRobustFtwoFix)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_DOUBTWO_ROBUST_FTWO_FIX_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_DOUBTWO_ROBUST_FTWO_FIX_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicDoubtwoRobustFtwoFix : public Pair {
 public:
  PairBohmSPHDynamicDoubtwoRobustFtwoFix(class LAMMPS *);
  virtual ~PairBohmSPHDynamicDoubtwoRobustFtwoFix();
