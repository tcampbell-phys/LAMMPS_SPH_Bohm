...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_doub_robust_F2_fix.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicDoubRobustFtwoFix::PairBohmSPHDynamicDoubRobustFtwoFix(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicDoubRobustFtwoFix::~PairBohmSPHDynamicDoubRobustFtwoFix()
{
  if (allocated) {
...
void PairBohmSPHDynamicDoubRobustFtwoFix::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicDoubRobustFtwoFix::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicDoubRobustFtwoFix::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicDoubRobustFtwoFix::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicDoubRobustFtwoFix::init_style()
{
...
double PairBohmSPHDynamicDoubRobustFtwoFix::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicDoubRobustFtwoFix::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicDoubRobustFtwoFix::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicDoubRobustFtwoFix::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicDoubRobustFtwoFix::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicDoubRobustFtwoFix::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicDoubRobustFtwoFix::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicDoubRobustFtwoFix::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicDoubRobustFtwoFix::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicDoubRobustFtwoFix::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
