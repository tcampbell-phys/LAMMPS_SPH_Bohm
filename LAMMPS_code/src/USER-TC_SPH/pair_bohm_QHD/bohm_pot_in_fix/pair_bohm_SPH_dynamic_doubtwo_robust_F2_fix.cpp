...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_doubtwo_robust_F2_fix.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicDoubtwoRobustFtwoFix::PairBohmSPHDynamicDoubtwoRobustFtwoFix(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicDoubtwoRobustFtwoFix::~PairBohmSPHDynamicDoubtwoRobustFtwoFix()
{
  if (allocated) {
...
void PairBohmSPHDynamicDoubtwoRobustFtwoFix::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicDoubtwoRobustFtwoFix::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicDoubtwoRobustFtwoFix::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicDoubtwoRobustFtwoFix::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicDoubtwoRobustFtwoFix::init_style()
{
...
double PairBohmSPHDynamicDoubtwoRobustFtwoFix::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicDoubtwoRobustFtwoFix::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicDoubtwoRobustFtwoFix::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicDoubtwoRobustFtwoFix::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicDoubtwoRobustFtwoFix::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicDoubtwoRobustFtwoFix::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicDoubtwoRobustFtwoFix::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicDoubtwoRobustFtwoFix::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicDoubtwoRobustFtwoFix::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicDoubtwoRobustFtwoFix::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
