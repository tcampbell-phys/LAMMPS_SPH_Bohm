...
PairStyle(bohm_SPH_dynamic_doub_sym_rob_ftwo_fix,PairBohmSPHDynamicDoubSymRobustFtwoFix)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_DOUB_SYM_ROBUST_FTWO_FIX_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_DOUB_SYM_ROBUST_FTWO_FIX_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicDoubSymRobustFtwoFix : public Pair {
 public:
  PairBohmSPHDynamicDoubSymRobustFtwoFix(class LAMMPS *);
  virtual ~PairBohmSPHDynamicDoubSymRobustFtwoFix();
