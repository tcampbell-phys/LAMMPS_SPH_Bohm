...
PairStyle(bohm_SPH_dynamic_Mocz_rob_fix,PairBohmSPHDynamicMoczRobustFix)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FIX_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FIX_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczRobustFix : public Pair {
 public:
  PairBohmSPHDynamicMoczRobustFix(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczRobustFix();
