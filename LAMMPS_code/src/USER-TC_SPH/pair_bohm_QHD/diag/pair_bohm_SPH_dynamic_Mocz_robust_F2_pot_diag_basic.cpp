...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_Mocz_robust_F2_pot_diag_basic.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::PairBohmSPHDynamicMoczRobustFtwoFixDiagBas(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::~PairBohmSPHDynamicMoczRobustFtwoFixDiagBas()
{
  if (allocated) {
...
void PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::init_style()
{
...
double PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicMoczRobustFtwoFixDiagBas::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
