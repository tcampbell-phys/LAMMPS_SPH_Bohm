...
PairStyle(bohm_SPH_dynamic_Mocz_rob_ftwo_diag,PairBohmSPHDynamicMoczRobustFtwoDiag)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FTWO_DIAG_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FTWO_DIAG_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczRobustFtwoDiag : public Pair {
 public:
  PairBohmSPHDynamicMoczRobustFtwoDiag(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczRobustFtwoDiag();
