...
- Non-diagonal pressure tensor entries zeroed.

Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_Mocz_robust_F2_diag.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicMoczRobustFtwoDiag::PairBohmSPHDynamicMoczRobustFtwoDiag(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicMoczRobustFtwoDiag::~PairBohmSPHDynamicMoczRobustFtwoDiag()
{
  if (allocated) {
...
void PairBohmSPHDynamicMoczRobustFtwoDiag::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicMoczRobustFtwoDiag::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicMoczRobustFtwoDiag::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicMoczRobustFtwoDiag::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicMoczRobustFtwoDiag::init_style()
{
...
double PairBohmSPHDynamicMoczRobustFtwoDiag::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicMoczRobustFtwoDiag::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoDiag::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoDiag::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwoDiag::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicMoczRobustFtwoDiag::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicMoczRobustFtwoDiag::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicMoczRobustFtwoDiag::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicMoczRobustFtwoDiag::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicMoczRobustFtwoDiag::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
