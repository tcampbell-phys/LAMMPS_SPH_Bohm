...
PairStyle(bohm_SPH_dynamic_Mocz_rob_ftwo_fix_diag,PairBohmSPHDynamicMoczRobustFtwoFixDiag)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FTWO_FIX_DIAG_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_FTWO_FIX_DIAG_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczRobustFtwoFixDiag : public Pair {
 public:
  PairBohmSPHDynamicMoczRobustFtwoFixDiag(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczRobustFtwoFixDiag();
