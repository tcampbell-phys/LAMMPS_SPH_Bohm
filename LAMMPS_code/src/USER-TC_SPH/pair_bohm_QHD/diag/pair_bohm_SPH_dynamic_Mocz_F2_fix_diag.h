...
PairStyle(bohm_SPH_dynamic_Mocz_ftwo_fix_diag,PairBohmSPHDynamicMoczFtwoFixDiag)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_FTWO_FIX_DIAG_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_FTWO_FIX_DIAG_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczFtwoFixDiag : public Pair {
 public:
  PairBohmSPHDynamicMoczFtwoFixDiag(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczFtwoFixDiag();
