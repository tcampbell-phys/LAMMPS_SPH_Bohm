...
PairStyle(bohm_SPH_dynamic_Mocz_vest,PairBohmSPHDynamicMoczVest)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_VEST_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_VEST_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczVest : public Pair {
 public:
  PairBohmSPHDynamicMoczVest(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczVest();
