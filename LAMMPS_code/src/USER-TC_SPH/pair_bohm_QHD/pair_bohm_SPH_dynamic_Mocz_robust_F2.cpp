...
Thomas Campbell
------------------------------------------------------------------------- */
#include "pair_bohm_SPH_dynamic_Mocz_robust_F2.h"
#include <mpi.h>
#include <cmath>
#include <cstring>
#include <math.h>
...
PairBohmSPHDynamicMoczRobustFtwo::PairBohmSPHDynamicMoczRobustFtwo(LAMMPS *lmp) : Pair(lmp) {
  nmax = 0;
...
PairBohmSPHDynamicMoczRobustFtwo::~PairBohmSPHDynamicMoczRobustFtwo()
{
  if (allocated) {
...
void PairBohmSPHDynamicMoczRobustFtwo::compute(int eflag, int vflag)
{
...
void PairBohmSPHDynamicMoczRobustFtwo::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairBohmSPHDynamicMoczRobustFtwo::settings(int narg, char **arg)
{
...
void PairBohmSPHDynamicMoczRobustFtwo::coeff(int narg, char **arg)
{
  if (narg < 2 || narg > 3)
...
void PairBohmSPHDynamicMoczRobustFtwo::init_style()
{
...
double PairBohmSPHDynamicMoczRobustFtwo::init_one(int i, int j)
{
  if (setflag[i][j] == 0)
...
void PairBohmSPHDynamicMoczRobustFtwo::write_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwo::read_restart(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwo::write_restart_settings(FILE *fp)
{
...
void PairBohmSPHDynamicMoczRobustFtwo::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
int PairBohmSPHDynamicMoczRobustFtwo::pack_forward_comm(int n, int *list, double *buf,
...
void PairBohmSPHDynamicMoczRobustFtwo::unpack_forward_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int PairBohmSPHDynamicMoczRobustFtwo::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void PairBohmSPHDynamicMoczRobustFtwo::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
void *PairBohmSPHDynamicMoczRobustFtwo::extract(const char *str, int &dim)
{
  dim = 2;
  return NULL;
}
