...
PairStyle(bohm_SPH_dynamic_Mocz_rob_pot,PairBohmSPHDynamicMoczRobustPot)

#else

#ifndef LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_POT_H
#define LMP_PAIR_BOHM_SPH_DYNAMIC_MOCZ_ROBUST_POT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmSPHDynamicMoczRobustPot : public Pair {
 public:
  PairBohmSPHDynamicMoczRobustPot(class LAMMPS *);
  virtual ~PairBohmSPHDynamicMoczRobustPot();
