#ifdef FIX_CLASS
FixStyle(dynamic_widths_com_MF,FixDynamicWidthsCoMMF)
#else
#ifndef LMP_FIX_DYNAMIC_WIDTHS_COM_MF_H
#define LMP_FIX_DYNAMIC_WIDTHS_COM_MF_H

#include "fix.h"

namespace LAMMPS_NS {
class FixDynamicWidthsCoMMF : public Fix {
 public:
  FixDynamicWidthsCoMMF(class LAMMPS *, int, char **);
  virtual ~FixDynamicWidthsCoMMF();
  int setmask();
  virtual void init();
