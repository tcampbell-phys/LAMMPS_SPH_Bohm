...
PairStyle(coul/long/SPH_ph_sub,PairCoulLongSPHphsub)

#else

#ifndef LMP_PAIR_COUL_LONG_SPH_PH_SUB_H
#define LMP_PAIR_COUL_LONG_SPH_PH_SUB_H
...
class PairCoulLongSPHphsub : public Pair {
 public:
  PairCoulLongSPHphsub(class LAMMPS *);
  ~PairCoulLongSPHphsub();
...
//   virtual double single(int, int, int, int, double, double, double, double &);
 ...
 protected:
  ...
  // K - scaled (for 50 elements per electron) GGA no erf contribution removed. Even temper generated.
  int al_gga_K_key = 105;
  int al_gga_K_ion_charge = 3;
  int al_gga_K_Ncoeff = 12;
  int al_gga_K_Nepe = 50;
  double al_gga_K_a[12] = {28.480358684358013, 10.0, 3.5111917342151315, 1.2328467394420664, 0.43287612810830595, 0.15199110829529341, 0.05336699231206311, 
  0.018738174228603847, 0.006579332246575677, 0.002310129700083161, 0.0008111308307896868, 0.0002848035868435803};
  double al_gga_K_c[12] = {-0.00036512798124022083, 0.0016798885299067479, -0.007610478680362576, 0.11013670233751327, -0.034909867267288064, -0.012044112775129179, 
  -0.009121121180214686, -0.003492663505312521, -0.0077071613995940425, 0.016207697946811095, -0.03466907568508759, 0.018182813742896542};
