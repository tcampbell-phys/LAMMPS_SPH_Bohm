#ifdef FIX_CLASS
FixStyle(dynamic_widths_com,FixDynamicWidthsCoM)
#else
#ifndef LMP_FIX_DYNAMIC_WIDTHS_COM_H
#define LMP_FIX_DYNAMIC_WIDTHS_COM_H

#include "fix.h"

namespace LAMMPS_NS {
class FixDynamicWidthsCoM : public Fix {
 public:
  FixDynamicWidthsCoM(class LAMMPS *, int, char **);
  virtual ~FixDynamicWidthsCoM();
  int setmask();
  virtual void init();
