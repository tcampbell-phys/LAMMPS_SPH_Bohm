...
do
    ...
    scp -r -oProxyCommand="ssh -W %h:%p campbellt@bastion.physics.ox.ac.uk" campbell@hedp64.nat.physics.ox.ac.uk:~/Documents/GitHub/LAMMPS_SPH_Bohm/outputs/hedp64/hedp_legacy_bohm_$i/
    scp -r -oProxyCommand="ssh -W %h:%p campbellt@bastion.physics.ox.ac.uk" campbell@hedp64.nat.physics.ox.ac.uk:~/Documents/GitHub/LAMMPS_SPH_Bohm/outputs/hedp64/hedp_SPH_bohm_$i/
done