...
scp ./Aluminium/in.pair_bohm_global_ion_al_70a scarf734@ui1.scarf.rl.ac.uk:~/mywork/LAMMPS/lammps-3Mar20/pair_bohm_global/
#rsync -auv LAMMPS_code/pair_bohm_global_ions.* scarf734@ui2.scarf.rl.ac.uk:~/mywork/LAMMPS/lammps-3Mar20/src/
#rsync -auv  LAMMPS_code/pair_bohm_full_ham.* scarf734@ui1.scarf.rl.ac.uk:~/mywork/LAMMPS/lammps-3Mar20/src/
#rsync -auv LAMMPS_code/pair_bohm_full_ham.cpp scarf734@ui2.scarf.rl.ac.uk:~/mywork/LAMMPS/lammps-3Mar20/src/
#LAMMPS_code/scp  pair_bohm_global*.h scarf734@ui1.scarf.rl.ac.uk:~/mywork/LAMMPS/lammps-3Mar20/src/
