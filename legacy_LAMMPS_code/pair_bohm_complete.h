...
PairStyle(bohm_global_ions,PairBohmGlobalIons)

#else

#ifndef LMP_PAIR_BOHM_GLOBAL_IONS_H
#define LMP_PAIR_BOHM_GLOBAL_IONS_H

#include "pair.h"

namespace LAMMPS_NS {

class PairBohmGlobalIons : public Pair {
 public:
  PairBohmGlobalIons(class LAMMPS *);
  virtual ~PairBohmGlobalIons();
