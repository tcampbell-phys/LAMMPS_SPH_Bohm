...
Atom::Atom(LAMMPS *lmp) : Pointers(lmp)
{
  ...
  beta_correction = NULL;

  //custom force terms arrays:

  sum_packets_d = NULL;
  first_order_x_term_d = NULL;
  first_order_y_term_d = NULL;
  first_order_z_term_d = NULL;
  phi_d = NULL;
  rho_x_d = NULL;
  rho_y_d = NULL;
  rho_z_d = NULL;
  ...
  theta_y_d = NULL;
  theta_z_d = NULL;
  second_order_x_term_d = NULL;
  second_order_y_term_d = NULL;
  second_order_z_term_d = NULL;
  third_order_x_term_d = NULL;
  third_order_y_term_d = NULL;
  third_order_z_term_d = NULL;
...
Atom::~Atom()
{
  ...
  memory->destroy(sum_packets_d);
  memory->destroy(first_order_x_term_d);
  memory->destroy(first_order_y_term_d);
  memory->destroy(first_order_z_term_d);
  memory->destroy(phi_d);
  memory->destroy(rho_x_d);
  memory->destroy(rho_y_d);
  memory->destroy(rho_z_d);
  memory->destroy(theta_x_d);
  memory->destroy(theta_y_d);
  memory->destroy(theta_z_d);
  memory->destroy(second_order_x_term_d);
  memory->destroy(second_order_y_term_d);
  memory->destroy(second_order_z_term_d);
  memory->destroy(third_order_x_term_d);
  memory->destroy(third_order_y_term_d);
  memory->destroy(third_order_z_term_d);
...
void *Atom::extract(char *name)
{
  ...
  if (strcmp(name,"sum_packets_d") == 0) return (void *) sum_packets_d;
  if (strcmp(name,"first_order_x_term_d") == 0) return (void *) first_order_x_term_d;
  if (strcmp(name,"first_order_y_term_d") == 0) return (void *) first_order_y_term_d;
  if (strcmp(name,"first_order_z_term_d") == 0) return (void *) first_order_z_term_d;
  if (strcmp(name,"phi_d") == 0) return (void *) phi_d;
  if (strcmp(name,"rho_x_d") == 0) return (void *) rho_x_d;
  if (strcmp(name,"rho_y_d") == 0) return (void *) rho_y_d;
  if (strcmp(name,"rho_z_d") == 0) return (void *) rho_z_d;
  if (strcmp(name,"theta_x_d") == 0) return (void *) theta_x_d;
  if (strcmp(name,"theta_y_d") == 0) return (void *) theta_y_d;
  if (strcmp(name,"theta_z_d") == 0) return (void *) theta_z_d;
  if (strcmp(name,"second_order_x_term_d") == 0) return (void *) second_order_x_term_d;
  if (strcmp(name,"second_order_y_term_d") == 0) return (void *) second_order_y_term_d;
  if (strcmp(name,"second_order_z_term_d") == 0) return (void *) second_order_z_term_d;
  if (strcmp(name,"third_order_x_term_d") == 0) return (void *) third_order_x_term_d;
  if (strcmp(name,"third_order_y_term_d") == 0) return (void *) third_order_y_term_d;
  if (strcmp(name,"third_order_z_term_d") == 0) return (void *) third_order_z_term_d;
