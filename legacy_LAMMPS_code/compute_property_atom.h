...
class ComputePropertyAtom : public Compute {
 ...
 private:
  ...
  // custom pack function for Beta Correction:

  void pack_beta_correction(int);

  //custom pack function for force terms:

  void pack_sum_packets_d(int);
  void pack_first_order_x_term_d(int);
  void pack_first_order_y_term_d(int);
  void pack_first_order_z_term_d(int);
  void pack_phi_d(int);
  void pack_rho_x_d(int);
  void pack_rho_y_d(int);
  void pack_rho_z_d(int);
  void pack_theta_x_d(int);
  void pack_theta_y_d(int);
  void pack_theta_z_d(int);
  void pack_second_order_x_term_d(int);
  void pack_second_order_y_term_d(int);
  void pack_second_order_z_term_d(int);
  void pack_third_order_x_term_d(int);
  void pack_third_order_y_term_d(int);
  void pack_third_order_z_term_d(int);
};
