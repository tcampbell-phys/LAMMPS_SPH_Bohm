...
rsync -azv -e 'ssh -o "ProxyCommand ssh -A campbellt@bastion.physics.ox.ac.uk -W %h:%p"' ../input_decks/allxfs1/H_research/ campbellt@allxfs1.physics.ox.ac.uk:~/fresh-lammps/lammps-3Mar20/SPH_Bohm/H_research/

rsync -azv -e 'ssh -o "ProxyCommand ssh -A campbellt@bastion.physics.ox.ac.uk -W %h:%p"' ../input_decks/allxfs1/coul_testing/ campbellt@allxfs1.physics.ox.ac.uk:~/fresh-lammps/lammps-3Mar20/SPH_Bohm/coul_testing/
